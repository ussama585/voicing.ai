...
const Script = ({ editorText, handleEditorChange }) => {
  ...
  return (
    <div className="text-left">
      ...
      <div>
        <h4 className='mb-5'>Select Voice</h4>
      ...
      <hr className='h-seperator' style={{ margin: "20px 0" }} />
      ...
      <div className="mt-2">
        <textarea
          ...
          className="script-textarea w-full p-2 border border-gray-300 rounded"
        />
      </div>

      <div className='flex items-center'>
        <hr className='h-seperator' style={{ width: "100%", height: "2px" }} />
        <img src={add} alt="" style={{ margin: "10px", width: "34px", height: "34px" }} />
        <img src={addTime} alt="" style={{ margin: "10px", width: "34px", height: "34px" }} />
        <hr className='h-seperator' style={{ width: "100%", height: "2px" }} />
      </div>

      <div className='flex flex-col gap-3'>
        <div>
          <button className='transparent-btn me-3'>Enter</button> <span>Add new script</span>
        </div>
        <div className='flex'>
          <button className='transparent-btn me-3' style={{ padding: "8px 6px", minWidth: "100px" }}>Shift + Enter</button> <span>Create newline within paragraph</span>
        </div>
      </div>
